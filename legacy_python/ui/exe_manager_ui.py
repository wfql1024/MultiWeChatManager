...
from legacy_python.components.composited_controls import ClassicAHT, CkbRow
from legacy_python.components.custom_widgets import CustomCornerBtn, CustomBtn
from legacy_python.components.widget_wrappers import SubToolWndUI, ScrollableCanvasW, ProgressBarW
...
from legacy_python.public.custom_classes import Condition, FlowControlError
from legacy_python.public.enums import CfgStatus, AccKeys, RemoteCfg, LocalCfg
...
from legacy_python.utils.logger_utils import Logger, Printer
...
class ExeManagerCkRow(CkbRow):
    ...
    def _create_coexist_row(self):
        ...
        if self.table_tag == CfgStatus.USING:
            ...
            self.patching_frame[RemoteCfg.REVOKE.value] = anti_revoke_frame
            # - 防撤回的按钮
            self._reload_coexist_patching_buttons(RemoteCfg.REVOKE.value, coexist_channel, ordinal)
